...
- Sample data is generated by scripts/generate_sample_data.py (seeded,
  ...
  2026-08-01..08-27 minus Sundays × 5 periods / one 30-seat hall /
  ~1400 lessons. Slot ids look like `0801-1` (= MMDD-period). v1 solves
  it in ~20 s thanks to unique-pair MRV with early-exit candidate
